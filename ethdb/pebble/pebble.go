...
func New(file string, cache int, handles int, namespace string, readonly bool) (*Database, error) {
	...
	logger.Info("Allocated cache and file handles", "cache", common.StorageSize(cache*1024*1024+1*1024*1024), "handles", handles)
	...
	opt := &pebble.Options{
		...
		Cache:        pebble.NewCache(int64(cache*1024*1024) + 1*1024*1024),
