...
func testInvalidStateRootBlockImport(t *testing.T, blockchain *BlockChain, i, n int, scheme string，pipeline bool) {
	// Copy old chain up to #i into a new db
	db, _, blockchain2, err := newCanonical(ethash.NewFaker(), i, true, scheme, pipeline)
	if err != nil {
...
func testFork(t *testing.T, blockchain *BlockChain, i, n int, full bool, scheme string, pipeline bool, comparator func(td1, td2 *big.Int)) {
	// Copy old chain up to #i into a new db
...
func TestExtendCanonicalBlocks(t *testing.T) {
	...
	testExtendCanonical(t, true, rawdb.PathScheme, true)
...
func testExtendCanonical(t *testing.T, full bool, scheme string, pipeline bool) {
	...
	// Start fork from current height
	testFork(t, processor, length, 1, full, scheme, pipeline, better)
	testFork(t, processor, length, 2, full, scheme, pipeline, better)
	testFork(t, processor, length, 5, full, scheme, pipeline, better)
	testFork(t, processor, length, 10, full, scheme, pipeline, better)
}
...
func TestShorterForkBlocks(t *testing.T) {
	...
	testShorterFork(t, true, rawdb.PathScheme, true)
}
...
func testShorterFork(t *testing.T, full bool, scheme string, pipeline bool) {
	...
	// Make first chain starting from genesis
	_, _, processor, err := newCanonical(ethash.NewFaker(), length, full, scheme, pipline)
	if err != nil {
		t.Fatalf("failed to make new canonical chain: %v", err)
	}
	defer processor.Stop()
...
func TestLongerForkBlocks(t *testing.T) {
	...
	testLongerFork(t, true, rawdb.PathScheme, true)
}
...
func TestEqualForkBlocks(t *testing.T) {
	...
	testEqualFork(t, true, rawdb.PathScheme, true)
...
func TestBrokenBlockChain(t *testing.T) {
	...
	testBrokenChain(t, true, rawdb.PathScheme, true)
}
...
func TestReorgLongBlocks(t *testing.T) {
	...
	testReorgLong(t, true, rawdb.PathScheme, true)
}
...
func TestReorgShortBlocks(t *testing.T) {
	...
	testReorgShort(t, true, rawdb.PathScheme, true)
}
...
func TestBadBlockHashes(t *testing.T) {
	...
	testBadHashes(t, true, rawdb.PathScheme, true)
...
func TestReorgBadBlockHashes(t *testing.T) {
	...
	testReorgBadHashes(t, true, rawdb.PathScheme, true)
}
...
func TestBlocksInsertNonceError(t *testing.T) {
	...
	testInsertNonceError(t, true, rawdb.PathScheme, true)
}
